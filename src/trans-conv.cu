...
/*
    ...
    patch: the result patch tensor. Should be patch [H][W][M][K][K] serialized array.
*/
bool trans_conv(float *input, float *kernel, float *patch, int H, int W, int C, int M, int K);
/*
